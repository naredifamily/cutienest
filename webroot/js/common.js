...
(function ($) {
	...
	*******************************/         
	...
	function getJoiningDate(user_id)	
{
	
   jQuery.ajax({url: SITE_URL+"users/getjoiningdate/"+user_id, success: function(result){
   jQuery("#joiningdate").val(result);
...
$(document).ready(function() {
  ...
  $('.success').delay(1000).hide('highlight', {color: '#66cc66'}, 1500);
});
$(document).ready(function() {
  // fade out flash 'success' messages
  $('.error').delay(1000).hide('highlight', {color: '#66cc66'}, 1500);
});