...
<?php echo $this->Form->create('Pagecontact', array('url' => 'contact','class'=>'form_searcharea','name'=>'contactform','id'=>'contactform')); ?>
			...
			<?php echo $this->Form->input('useraddress', ['type' => 'textarea','style'=>'resize:none;','required' => true,'value'=>@$user['User']['address'], 'label' => false,'class'=>'input-class-search']); ?>
			...
			<?php echo $this->Form->input('usermessage', ['type' => 'textarea','style'=>'resize:none;','required' => true,'value'=>@$user['User']['message'], 'label' => false,'class'=>'input-class-search']); ?>
