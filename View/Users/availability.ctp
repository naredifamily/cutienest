...
<tr>
<td data-th="" colspan="3"><input <?php if(empty($data_array)){?> checked="checked" <?php }?> onclick="avail('Y')"  type="radio" class="avail-radio" name="type" value="Fullday">All spots available</td>


</tr>

<tr>
<td data-th="" colspan="3"><input  <?php if(!empty($data_array)){?> checked="checked" <?php }?> onclick="avail('N')" type="radio" class="avail-radio" name="type" value="Halfday">Spots available</td>
...
<tr>
<td colspan="2"><span class="careof"><input type="checkbox" <?php if($careof_weekend==1){?> checked="checked" <?php }?> name="careof_weekend" class="css-checkbox" id="checkbox12"  value="1"><label for="checkbox12" class="css-label">Provide Care on Weekends</label></span></td>
<td colspan="2"><span class="careof"><input type="checkbox" <?php if($careof_holiday==1){?> checked="checked" <?php }?> name="careof_holiday"  class="css-checkbox" id="checkbox13" value="1"><label for="checkbox13" class="css-label">Provide Care on Holidays</label></span></td>
</tr>
</table>
