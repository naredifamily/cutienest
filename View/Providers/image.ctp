...
<div class="uploads">
<form action="<?=Configure::read('SITE_URL')?>providers/makefeature" id="ckb" name="form1">
...
<div class="u_images_blk_img"><img src="<?php echo Configure::read('SITE_URL') ?>uploads/gallery/<?=$image['Image']['path']?>" alt="">

<div class="port_hover">
<div class="p_options">
<a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo Configure::read('SITE_URL') ?>uploads/gallery/<?=$image['Image']['path']?>"><img src="<?php echo Configure::read('SITE_URL') ?>images/search-icon.png" alt=""></a>
<span><img src="<?php echo Configure::read('SITE_URL') ?>images/icon-divider.png" alt=""></span>

<a href="<?=Configure::read('SITE_URL').'providers/imageDelete/'.$image['Image']['id']?>"><img src="<?=Configure::read('SITE_URL').'images/delete-icon.png'?>"></a>
...
var totalCheckboxes = $('input:checkbox').length;
	...
	for(var i=0; i < document.form1.ckb.length; i++){
		...
		jQuery.ajax({
			url: "<?php echo Configure::read('SITE_URL') ?>/providers/makeFeatureImg/",
