...
<td data-th="Due Date"><?=$due_date?></td>
...
<?php if($invoice['Invoice']['status']=='0'){?><a href="<?=Configure::read('SITE_URL')?>invoices/changestatus/<?=$invoice['Invoice']['id']?>" title="Active"><i class="fa fa-check" aria-hidden="true"></i></a><span>/<?php }?></span>
					...
					<?php if($invoice['Invoice']['status']=='0'){?><span>/</span><a href="<?=Configure::read('SITE_URL')?>providers/updateInvoice/<?=$invoice['Invoice']['id']?>" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a><?php } ?>
					<span></span>
                   </td>
</tr>
<?php $i++; }?>
...
<a href="<?=Configure::read('SITE_URL')?>providers/createInvoice"><i class="fa fa-plus" aria-hidden="true"></i>Create New Invoice</a>
</div>
<?php }?>
<script>
