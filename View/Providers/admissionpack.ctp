...
<td data-th="Day"><a href="<?=Configure::read('SITE_URL')?>/uploads/admissionpack/<?=$result['Admissionpack']['path']?>"><?=$result['Admissionpack']['path']?></a></td>
<td data-th="Day"><a href="<?=Configure::read('SITE_URL')?>/providers/deletepack/<?=$result['Admissionpack']['id']?>" title="Delete" ><i style="color:red" class="fa fa-times-circle"></i></a></td>
</tr>
<?php }?>
</tbody></table>
</div>
