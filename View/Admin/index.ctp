...
<div class="row page-titles">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <a href="<?php echo Configure::read('ADMIN_URL') ?>userAdd" class="btn pull-right hidden-sm-down btn-success"> + Add Providers</a>
                    </div>
                </div>
<div class="row">
                    <!-- column -->
                                              ...
                                              echo $this->Form->postLink($this->Html->tag('i', '', 
                                               ...
                                               |
												...
												array('title' => 'Activate',
        												  'class'  => 'tooltip','escape'=>false),    
												__('Are you sure you want Activate # %s?', $user['User']['name']),
											   array('class' => 'btn btn-mini')
												...
												array('title' => 'Deactivate',
        												  'class'  => 'tooltip','escape'=>false),    
												__('Are you sure you want to Deactivate # %s?', $user['User']['name']),
											   array('class' => 'btn btn-mini')
												); 		  
													 } */ ?>   
